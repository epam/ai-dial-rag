...
from aidial_rag.indexing_api import create_indexing_results
...
def _return_indexing_results(
    ...
    indexing_response, index_attachments = create_indexing_results(
        indexing_results
    )
    for attachment in index_attachments:
